...
(function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t2 = space();
    			div0 = element("div");
    			div0.textContent = "This page has been open for";
    		},
    		m(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*store*/ 2) {
    			 autorun(() => {
    				$$invalidate(0, x = store.sessionStore.entryMessage);
    			});
    		}
    	};
    ...
    (function (ActionRequestEnum) {
        ActionRequestEnum["getSessionId"] = "getSessionId";
        ActionRequestEnum["closeSession"] = "closeSession";
        ActionRequestEnum["userEventSource"] = "userEventSource";
