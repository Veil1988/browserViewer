...
(function () {
    ...
    /* src/operator/App.svelte generated by Svelte v3.31.2 */
    const file = "src/operator/App.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t0 = text("The time is ");
    			t1 = text(/*currentTimeString*/ ctx[0]);
    			t2 = space();
    			div0 = element("div");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*currentTimeString*/ 1) set_data_dev(t1, /*currentTimeString*/ ctx[0]);
    			if (dirty & /*elapsedSecondsString*/ 2) set_data_dev(t4, /*elapsedSecondsString*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("vm" in $$props) $$invalidate(2, vm = $$props.vm);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("vm" in $$props) $$invalidate(2, vm = $$props.vm);
    		if ("currentTimeString" in $$props) $$invalidate(0, currentTimeString = $$props.currentTimeString);
    		if ("elapsedSecondsString" in $$props) $$invalidate(1, elapsedSecondsString = $$props.elapsedSecondsString);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*vm*/ 4) {
    			 autorun(() => {
    				$$invalidate(0, currentTimeString = vm.currentTimeString);
    				$$invalidate(1, elapsedSecondsString = vm.elapsedSecondsString);
    			});
    		}
    	};

    	return [currentTimeString, elapsedSecondsString, vm];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { vm: 2 });
    		...
    		if (/*vm*/ ctx[2] === undefined && !("vm" in props)) {
    			console.warn("<App> was created without expected prop 'vm'");
    		}
    	}
